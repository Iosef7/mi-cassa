...
const LeadCard = React.memo(({ lead, handleDragStart }: { lead: Lead, handleDragStart: (e: React.DragEvent, id: string) => void }) => {
  return (
    <div
      draggable
            ...
            <div className="flex-1 min-h-0 p-3">
              <Virtuoso
                ...
                itemContent={(index, lead) => (
                  <div className="pb-3">
                    <LeadCard lead={lead} handleDragStart={handleDragStart} />
                  </div>
                )}
              />
            </div>
