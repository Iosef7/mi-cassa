            ...
            <div className="p-3 overflow-y-auto flex-1 flex flex-col gap-3">
              {columnLeads.map(lead => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-3">{lead.phone}</p>
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
                      <div className="flex items-center gap-1" title="Llamadas">
                      ...
                      <div className="flex items-center gap-1" title="Tareas">
                        <CheckCircle size={12} className={lead._count.tasks > 0 ? "text-amber-500 dark:text-amber-400" : ""} />
